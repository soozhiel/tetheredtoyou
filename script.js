const SITE_URL = 'https://bornwithoutexpectations.vercel.app';
...
async function sharePage() {
  if (navigator.share) { try { await navigator.share({ title: 'Born Without Expectations — Sonic Remedy | Soozhee', text: 'Born Without Expectations by Soozhee. Sonic Remedy : Audiosensory Resonance | Letting Go.', url: SITE_URL }); return; } catch (e) {} }
